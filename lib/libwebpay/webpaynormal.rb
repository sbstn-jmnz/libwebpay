...
class WebpayNormal
  def initialize(configuration)
    ...
    @wsdl_path = web_service_path(environment)
  ...
  def initTransaction(amount, order, session_id, url_return, url_final)
    init_input = {
    ...
    req = @client.build_request(:init_transaction, message: init_input)
  ...
  def web_service_path(environment)
    case environment
    when 'INTEGRACION'
